...
PROVIDERS = [
    {"id": "baku_metro", "name": "Baku Metropolitan (BMA)", "type": "Transit Authority", "provenance": "official", "modes": ["metro"], "coverage": "3 lines, 27 stations", "last_updated": "2025-01-15T10:30:00Z", "reliability": 0.94, "description": "Official schedule and station data from Baku Metro", "endpoints": 4, "freshness_hours": 24},
    {"id": "baku_bus", "name": "BakuBus LLC", "type": "Transit Operator", "provenance": "official", "modes": ["bus"], "coverage": "85 routes, 1200+ stops", "last_updated": "2025-01-14T16:00:00Z", "reliability": 0.89, "description": "Official GTFS feed from BakuBus operator", "endpoints": 6, "freshness_hours": 12},
    {"id": "bna", "name": "Baku Transport Agency (BNA)", "type": "Regulatory Authority", "provenance": "official_alerts_only", "modes": ["bus", "metro", "minibus"], "coverage": "All public transport", "last_updated": "2025-01-13T08:00:00Z", "reliability": 0.92, "description": "Service alerts and regulatory notices", "endpoints": 2, "freshness_hours": 48},
    {"id": "bolt_az", "name": "Bolt Azerbaijan", "type": "Ride-hailing", "provenance": "licensed_partner", "modes": ["taxi"], "coverage": "Baku metropolitan", "last_updated": "2025-01-15T12:00:00Z", "reliability": 0.91, "description": "Licensed API for ETA and availability", "endpoints": 3, "freshness_hours": 1},
    {"id": "uber_baku", "name": "Uber Baku", "type": "Ride-hailing", "provenance": "licensed_partner", "modes": ["taxi"], "coverage": "Baku city center", "last_updated": "2025-01-15T11:45:00Z", "reliability": 0.88, "description": "Licensed partner integration for ride estimates", "endpoints": 3, "freshness_hours": 1},
    {"id": "google_traffic", "name": "Google Maps Traffic", "type": "Traffic Data", "provenance": "public_web_observed", "modes": ["private_car", "walking", "bicycle"], "coverage": "Baku road network", "last_updated": "2025-01-15T12:15:00Z", "reliability": 0.85, "description": "Publicly observed traffic conditions", "endpoints": 2, "freshness_hours": 0.5},
    {"id": "yandex_maps", "name": "Yandex Maps", "type": "Navigation", "provenance": "public_web_observed", "modes": ["private_car", "walking"], "coverage": "Azerbaijan nationwide", "last_updated": "2025-01-15T12:10:00Z", "reliability": 0.83, "description": "Publicly observed navigation data", "endpoints": 2, "freshness_hours": 0.5},
    {"id": "osm_baku", "name": "OpenStreetMap Baku", "type": "Community Map", "provenance": "public_web_observed", "modes": ["walking", "bicycle", "wheelchair"], "coverage": "Baku full city", "last_updated": "2025-01-10T00:00:00Z", "reliability": 0.78, "description": "Community map data for pedestrian infrastructure", "endpoints": 1, "freshness_hours": 168},
    {"id": "baku_taxi_obs", "name": "Baku Street Taxis", "type": "Observed", "provenance": "public_undocumented", "modes": ["taxi"], "coverage": "Major intersections", "last_updated": "2025-01-14T09:00:00Z", "reliability": 0.55, "description": "Observed taxi availability at major stands", "endpoints": 0, "freshness_hours": 72},
    {"id": "minibus_obs", "name": "Minibus Routes Network", "type": "Observed", "provenance": "public_undocumented", "modes": ["minibus"], "coverage": "65+ observed routes", "last_updated": "2025-01-12T14:00:00Z", "reliability": 0.60, "description": "Community-observed minibus routes", "endpoints": 0, "freshness_hours": 120},
    ...
    {"id": "sentinel_eo", "name": "Copernicus Sentinel-2", "type": "Earth Observation", "provenance": "official", "modes": [], "coverage": "Baku metro area (10m)", "last_updated": "2025-01-13T09:30:00Z", "reliability": 0.97, "description": "ESA satellite imagery for urban context", "endpoints": 1, "freshness_hours": 120},
]

ALERTS = [
    {"id": "alert_001", "title": "Red Line Service Reduced", "severity": "warning", "type": "service_change", "source": "baku_metro", "provenance": "official", "mode": "metro", "description": "Reduced frequency on Red Line due to maintenance between Ulduz and Koroglu. Trains every 8 min instead of 4.", "affected_area": "Ulduz to Koroglu", "start_time": "2025-01-15T06:00:00Z", "end_time": "2025-01-15T22:00:00Z", "status": "active"},
    {"id": "alert_002", "title": "Route 65 Temporary Diversion", "severity": "info", "type": "route_change", "source": "baku_bus", "provenance": "official", "mode": "bus", "description": "Route 65 diverted via Nizami Street due to road works. Three stops temporarily relocated.", "affected_area": "Nizami district", "start_time": "2025-01-14T00:00:00Z", "end_time": "2025-01-20T23:59:00Z", "status": "active"},
    {"id": "alert_003", "title": "Elevated Congestion Near 28 May", "severity": "warning", "type": "congestion", "source": "google_traffic", "provenance": "public_web_observed", "mode": "private_car", "description": "Congestion levels 40% above average near 28 May intersection during evening hours.", "affected_area": "28 May area", "start_time": "2025-01-15T16:00:00Z", "end_time": "2025-01-15T20:00:00Z", "status": "active"},
    {"id": "alert_004", "title": "Green Line Signal Issue Resolved", "severity": "resolved", "type": "incident", "source": "baku_metro", "provenance": "official", "mode": "metro", "description": "Signal malfunction at Khatai station resolved. Normal service resumed.", "affected_area": "Khatai station", "start_time": "2025-01-14T14:00:00Z", "end_time": "2025-01-14T16:30:00Z", "status": "resolved"},
    {"id": "alert_005", "title": "Wheelchair Ramp Maintenance at Sahil", "severity": "info", "type": "accessibility", "source": "baku_metro", "provenance": "official", "mode": "wheelchair", "description": "Elevator at Sahil station entrance B under maintenance. Use entrance A.", "affected_area": "Sahil station", "start_time": "2025-01-15T09:00:00Z", "end_time": "2025-01-17T18:00:00Z", "status": "active"},
    {"id": "alert_006", "title": "Minibus Route 145 Schedule Change", "severity": "info", "type": "schedule", "source": "minibus_obs", "provenance": "public_undocumented", "mode": "minibus", "description": "Observed frequency reduction on Route 145 during midday hours.", "affected_area": "Binagadi to Nasimi", "start_time": "2025-01-13T10:00:00Z", "end_time": None, "status": "active"},
]
...
CONGESTION_FORECAST = {
    ...
    "last_trained": "2025-01-14T00:00:00Z"
}

EARTH_OBSERVATION = {
    "last_capture": "2025-01-13T09:30:00Z",
